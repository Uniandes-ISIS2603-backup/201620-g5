(function (ng) {
    ...
    mod.controller("prestamosSolosCtrl", ['$scope', '$state', '$stateParams', '$http','usuariosContext',  
        function ($scope, $state, $stateParams, $http, usuariosContext ) {
            ...
            $scope.prestamos = {};
            // carga las prestamos
            $http.get($scope.prestamosContext).then(function (response) {
            ...
            if ($stateParams.prestamoId !== null && $stateParams.prestamoId !== undefined) {
                ...
                $http.get($scope.prestamosContext + "/" + id)
            ...
            this.savePrestamo = function (id) {
                ...
                if (id == null) {
                    ...
                    return $http.put($scope.prestamosContext + "/" + currentPrestamo.id + "/usuarios/idUsuario/fecha", currentPrestamo)
                            .then(function () {
                                // $http.put es una promesa
                                // cuando termine bien, cambie de estado
                                $state.go('prestamosSolosList');
                            }, responseError);
                }
                ;
            };
